...
private:
   ...
   BOOLEAN_TYPE write(uint8_t header, uint8_t* buf, uint16_t length);
...
public:
   ...
   BOOLEAN_TYPE setBufferSize(uint16_t size);
   uint16_t getBufferSize();

   BOOLEAN_TYPE connect(const char* id);
   BOOLEAN_TYPE connect(const char* id, const char* user, const char* pass);
   BOOLEAN_TYPE connect(const char* id, const char* willTopic, uint8_t willQos, BOOLEAN_TYPE willRetain, const char* willMessage);
   BOOLEAN_TYPE connect(const char* id, const char* user, const char* pass, const char* willTopic, uint8_t willQos, BOOLEAN_TYPE willRetain, const char* willMessage);
   BOOLEAN_TYPE connect(const char* id, const char* user, const char* pass, const char* willTopic, uint8_t willQos, BOOLEAN_TYPE willRetain, const char* willMessage, BOOLEAN_TYPE cleanSession);
   void disconnect();
   BOOLEAN_TYPE publish(const char* topic, const char* payload);
   BOOLEAN_TYPE publish(const char* topic, const char* payload, BOOLEAN_TYPE retained);
   BOOLEAN_TYPE publish(const char* topic, const uint8_t * payload, unsigned int plength);
   BOOLEAN_TYPE publish(const char* topic, const uint8_t * payload, unsigned int plength, BOOLEAN_TYPE retained);
   BOOLEAN_TYPE publish_P(const char* topic, const char* payload, BOOLEAN_TYPE retained);
   BOOLEAN_TYPE publish_P(const char* topic, const uint8_t * payload, unsigned int plength, BOOLEAN_TYPE retained);
